...
function multitaskingButtonUp() {
  var newMain = document.getElementById("mainDiv" + currentDiv);
  if (!newMain) {
    console.error("Element with ID 'mainDiv" + currentDiv + "' not found.");
    return;
  }

  var currentMain = document.getElementById("mainDiv" + (currentMultitask + 1));
  if (currentMain) {
	  currentMultitask++
    currentMain.style.width = "70%";
    currentMain.style.height = "54vh";
	
    currentMain.style.display = "block";
  } else {
    console.error("Element with ID 'mainDiv" + (currentMultitask + 1) + "' not found.");
  }
  
  newMain.style.width = "0%";
  newMain.style.float = "initial";
  newMain.style.padding = "0px";
  newMain.style.border = "none";
...
function multitaskingButtonDown() {
  var newMain = document.getElementById("mainDiv" + currentDiv);
  if (!newMain) {
    console.error("Element with ID 'mainDiv" + currentDiv + "' not found.");
    return;
  ...
  var currentMain = document.getElementById("mainDiv" + (currentDiv - 1));
  if (currentMain) {
    currentMain.style.width = "70%";
    currentMain.style.height = "54vh";
	  newMain.style.float = "initial";
    ...
    console.error("Element with ID 'mainDiv" + (currentDiv + 1) + "' not found.");
  }
...
setInterval(buttonShowDown, 100)
setInterval(buttonShowUp, 100)